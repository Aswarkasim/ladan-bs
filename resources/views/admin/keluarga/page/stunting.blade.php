@php
    ...
    if ($cari) {
        $stunting = App\Models\Stunting::where('name', 'like', '%' . $cari . '%')->latest()->paginate(10);
    } else {
        $stunting = App\Models\Stunting::latest()->paginate(10);
    }

@endphp

<a href="/admin/tahunan/stunting/create" class="btn btn-primary mb-3"><i class="fa fa-plus"></i> Tambah</a>
